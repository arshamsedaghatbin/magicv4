...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKMARKACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOOKMARKACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOOKMARKACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOOKMARKACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOOKMARKACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOOKMARKACTION actions', async () => {
      const expectedActions = [
        {
