  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="magicv4App.bookMarkAction.home.createOrEditLabel" data-cy="BookMarkActionCreateUpdateHeading">
            <Translate contentKey="magicv4App.bookMarkAction.home.createOrEditLabel">Create or edit a BookMarkAction</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('magicv4App.bookMarkAction.userDescription')}
              ...
              <ValidatedField
                ...
                name="actionId"
                data-cy="action"
                label={translate('magicv4App.bookMarkAction.action')}
                type="select"
              >
                <option value="" key="0" />
                {actions
