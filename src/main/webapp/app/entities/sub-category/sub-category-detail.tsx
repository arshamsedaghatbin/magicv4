    ...
    <Row>
      <Col md="8">
        <h2 data-cy="subCategoryDetailsHeading">
          <Translate contentKey="magicv4App.subCategory.detail.title">SubCategory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="magicv4App.subCategory.title">Title</Translate>
            </span>
          </dt>
          <dd>{subCategoryEntity.title}</dd>
          <dt>
            <span id="photoUrl">
              <Translate contentKey="magicv4App.subCategory.photoUrl">Photo Url</Translate>
            </span>
          </dt>
          <dd>{subCategoryEntity.photoUrl}</dd>
          <dt>
            <span id="photo">
              <Translate contentKey="magicv4App.subCategory.photo">Photo</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="voiceUrl">
              <Translate contentKey="magicv4App.subCategory.voiceUrl">Voice Url</Translate>
            </span>
          </dt>
          <dd>{subCategoryEntity.voiceUrl}</dd>
          <dt>
            <span id="voiceFile">
              <Translate contentKey="magicv4App.subCategory.voiceFile">Voice File</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="masterAdvice">
              <Translate contentKey="magicv4App.subCategory.masterAdvice">Master Advice</Translate>
            </span>
          </dt>
          <dd>{subCategoryEntity.masterAdvice}</dd>
          <dt>
            <Translate contentKey="magicv4App.subCategory.action">Action</Translate>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="magicv4App.subCategory.category">Category</Translate>
          </dt>
